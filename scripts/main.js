...
function getWeatherAPIdata(id) {
	...
	switch(id){
		case 1:
			request= 'https://api.openweathermap.org/data/2.5/weather?q=London,gb&appid=0a51065693a4d2c800cd740ee0467c1e&units=metric';
			land= "Verenigde koninkrijk";
			stad= "Londen"; 
			break;
		case 2:
			request= 'https://api.openweathermap.org/data/2.5/weather?q=The%20Hague,nl&appid=0a51065693a4d2c800cd740ee0467c1e&units=metric';
			land= "Nederland";
			stad= "Den Haag"; 
			break;
		case 3:
			request= 'https://api.openweathermap.org/data/2.5/weather?q=Oranjestad,aw&appid=0a51065693a4d2c800cd740ee0467c1e&units=metric';
			land= "Aruba";
			stad= "Oranjestad"; 
			break;
		case 4:
			request= 'https://api.openweathermap.org/data/2.5/weather?q=Washington,us&appid=0a51065693a4d2c800cd740ee0467c1e&units=metric';
